  ...
  <tr><td colspan="2" height="100">
   ...
   <tr><td class="style6">
     ...
     <td>
       ...
       <tr><td width="20%">商品编号</td><td width="20%">商品名称</td><td width="20%">商品类别</td><td width="20%">买家姓名</td><td width="20%"></td></tr>
          <% 
         ...
         <tr>
           ...
           <td>
             <a href="../action/changeflag.jsp?side=sell&orderno=<%=hash.get("orderno") %>"><input type="button" value="已发货"></a>
       ...
       <table width="100%">
         <tr>
           ...
           int nowpage=Integer.parseInt(count)%Integer.parseInt(pagesize)==0?Integer.parseInt(count)/Integer.parseInt(pagesize):Integer.parseInt(count)/Integer.parseInt(pagesize)+1;
            ...
            <td align="right">
              <a href="../action/showunfinishselling.jsp?pagesize=<%=pagesize %>&pageno=<%= firstpage %>">首页</a>
              <a href="../action/showunfinishselling.jsp?pagesize=<%=pagesize %>&pageno=<%= prepage %>">上一页</a>
              <a href="../action/showunfinishselling.jsp?pagesize=<%=pagesize %>&pageno=<%= nextpage %>">下一页</a>
              <a href="../action/showunfinishselling.jsp?pagesize=<%=pagesize %>&pageno=<%= lastpage %>">尾页</a></td>
         </tr>
       </table>
     </td>
   </tr>
