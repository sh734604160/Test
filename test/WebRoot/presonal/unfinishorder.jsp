   ...
   <tr><td class="style6">
     ...
     <div class="style9">
       <table width="100%">
         ...
         <tr><td></td></tr>
         <tr><td class="style11"><a href="unfinishorder.jsp">&nbsp&nbsp-未完订单信息</a></td></tr>
         <tr><td></td></tr>
     ...
     <td>
       <table width="100%">
       <tr><td align="right">
       <a href="../action/showunfinishbuying.jsp"><input type="button" value="正在购买中"></a></td>
       <td align="left">
       <a href="../action/showunfinishselling.jsp"><input type="button" value="正在出售中"></a></td></tr>
       </table>
     </td>
   </tr>
   <tr>
