...
String othersex=sex.equals("男")?"女":"男";
 %>
<!DOCTYPE html>
<html>
<head>
...
<table class="style1">
  <tr><td colspan="2" height="100">
   ...
   <tr><td class="style6">
     ...
     <td>
     <form action="../action/updatepersonalinfor.jsp" method="post">
       <table width="100%" height="100%">
       <tr><td></td><td></td></tr>
       <tr><td align="center" colspan="2">您的个人信息如下，可以点击修改来更新您的个人信息。</td></tr>
       <tr><td colspan="2"><hr></td></tr>
       <tr><td align="right" width="45%">姓名：</td><td><input type="text" name="name1" value="<%=name%>"></td></tr>
       <tr><td align="right">性别：</td><td><input type="radio" name="sex1" value="<%=sex%>" checked><%=sex%><input type="radio" value="<%=othersex%>" name="sex1"><%=othersex%></td></tr>
       <tr><td align="right">手机：</td><td><input type="phone" name="phone1" value="<%=phone%>"></td></tr>
