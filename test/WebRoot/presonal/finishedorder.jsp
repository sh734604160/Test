  ...
  <tr><td colspan="2" height="100">
   ...
   <tr><td class="style6">
     ...
     <td>
       ...
       <tr><td width="20%">订单编号</td><td width="20%">商品名称</td><td width="20%">商品类别</td><td width="20%">卖家/买家姓名</td><td width="20%"></td></tr>
          <% 
       ...
       <table width="100%">
         <tr>
           ...
           int nowpage=Integer.parseInt(count)%Integer.parseInt(pagesize)==0?Integer.parseInt(count)/Integer.parseInt(pagesize):Integer.parseInt(count)/Integer.parseInt(pagesize)+1;
            ...
            <td align="right">
              <a href="../action/showfinishedorder.jsp?pagesize=<%=pagesize %>&pageno=<%= firstpage %>">首页</a>
              <a href="../action/showfinishedorder.jsp?pagesize=<%=pagesize %>&pageno=<%= prepage %>">上一页</a>
              <a href="../action/showfinishedorder.jsp?pagesize=<%=pagesize %>&pageno=<%= nextpage %>">下一页</a>
              <a href="../action/showfinishedorder.jsp?pagesize=<%=pagesize %>&pageno=<%= lastpage %>">尾页</a></td>
         </tr>
       </table>
     </td>
   </tr>
