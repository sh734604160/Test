...
<%!public void list(HttpServletRequest request,String strpagesize,String strpageno,String type){
try{
  ...
  int length=pageSize;
  String sql="select count(*) as countall from goods where gtypeno='"+type+"' and isselled='0'";
  ...
  strpagesize=length+"";
    sql="select * from goods where gtypeno='"+type+"' and isselled='0' order by goodsno limit "+start+","+length;
...
%>
<%
String topage="../goods-type/electronic-product.jsp";
  ...
  list(request,pagesize,pageno,type);
%>
