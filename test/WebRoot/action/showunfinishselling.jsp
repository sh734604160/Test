...
try{
  ...
  int length=pageSize;
  String sql="select count(*) as countall from orders where salername='"+user+"' and sellerflag='0'";
  ...
  strpagesize=length+"";
    sql="select orderno,goodsno,buyername from orders where salername='"+user+"' and sellerflag='0' order by orderno limit "+start+","+length;
    ResultSet re2=stm.executeQuery(sql);
    List<Hashtable<String,String>> list=new ArrayList<Hashtable<String,String>>();
    while(re2.next()){
      String orderno=re2.getString(1);
      String goodsno=re2.getString(2);
      String buyername=re2.getString(3);
...
%>
<%
String topage="../presonal/showselling.jsp";
