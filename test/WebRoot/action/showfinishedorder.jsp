...
try{
  ...
  int length=pageSize;
  String sql="select count(*) as countall from orders where (buyername='"+user+"' or salername='"+user+"') and buyerflag='1' and sellerflag='1'";
  ...
  strpagesize=length+"";
    sql="select goodsno,buyername,salername from orders where (buyername='"+user+"' or salername='"+user+"') and buyerflag='1' and sellerflag='1' order by orderno limit "+start+","+length;
    ResultSet re2=stm.executeQuery(sql);
    List<Hashtable<String,String>> list=new ArrayList<Hashtable<String,String>>();
    while(re2.next()){
      String flag="";
      String other="";
      String goodsno=re2.getString(1);
      String buyername=re2.getString(2);
      String salername=re2.getString(3);
...
%>
<%
String topage="../presonal/finishedorder.jsp";
